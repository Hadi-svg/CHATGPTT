    ...
    <div className="bg-background relative mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 px-[var(--thread-padding-x)] pb-4 md:pb-6">
      ...
      <ComposerPrimitive.Root className="focus-within::ring-offset-2 relative flex w-full flex-col rounded-2xl focus-within:ring-2 focus-within:ring-black dark:focus-within:ring-white">
        ...
        <ComposerPrimitive.Input
          ...
          className="bg-muted border-border dark:border-muted-foreground/15 focus:outline-primary placeholder:text-muted-foreground max-h-[calc(50dvh)] min-h-16 w-full resize-none border-x border-t px-4 pt-2 pb-3 text-base outline-none rounded-t-2xl"
          rows={1}
          autoFocus
  ...
  return (
    <MessagePrimitive.Root asChild>
      <motion.div
        ...
        className="relative mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col items-end px-[var(--thread-padding-x)] py-4"
        initial={{ y: 5, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        data-role="user"
      >
        ...
        <BranchPicker className="mr-14 mt-2" />
      </motion.div>
    </MessagePrimitive.Root>
  );
};
...
const UserActionBar: FC = () => {
  return (
    <ActionBarPrimitive.Root
      ...
      className="mt-2.5 flex flex-col items-end"
    >
